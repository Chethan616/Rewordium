...
SPDX-FileCopyrightText: 2025 The ReBoard Contributors
...
1. If at any point you used AI's work in your contribution you must ensure that you can submit this under the [license of the project](https://github.com/ReBoard/ReBoard/blob/main/LICENSE).
...
5. The use of AI in an autonomous manner to contribute to ReBoard is prohibited. This restriction also applies to the usage of AI agents or "vibe coding".
6. Upon violation of this agreement it is up to the discretion of the maintainer team to handle it like a violation of [ReBoard's Code of Conduct](https://github.com/ReBoard/ReBoard/blob/main/CODE_OF_CONDUCT.md).
