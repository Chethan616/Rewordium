...
FabMenuM3E _buildMenu(
  ...
  final showOverlay =
      context.knobs.boolean(label: 'overlay', initialValue: overlay);
  ...
  final popOnTap =
      context.knobs.boolean(label: 'popOnItemTap', initialValue: popOnItemTap);
