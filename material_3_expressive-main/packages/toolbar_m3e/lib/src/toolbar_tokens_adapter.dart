...
class ToolbarTokensAdapter {
  ...
  ShapeBorder shape(ToolbarM3EShapeFamily family) {
    final set = family == ToolbarM3EShapeFamily.round
        ? _m3e.shapes.round
        : _m3e.shapes.square;
