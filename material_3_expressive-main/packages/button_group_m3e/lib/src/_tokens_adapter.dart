...
_GroupMetrics metricsFor(BuildContext context, ButtonGroupM3ESize size,
    ButtonGroupM3EDensity density) {
...
BorderRadius radiusFor(
    BuildContext context, ButtonGroupM3EShape shape, ButtonGroupM3ESize size) {
  final m3e = Theme.of(context).extension<M3ETheme>() ??
      M3ETheme.defaults(Theme.of(context).colorScheme);
  final set =
      shape == ButtonGroupM3EShape.round ? m3e.shapes.round : m3e.shapes.square;
  switch (size) {
    case ButtonGroupM3ESize.xs:
      return set.xs;
    case ButtonGroupM3ESize.sm:
