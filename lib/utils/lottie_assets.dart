...
class LottieAssets {
  ...
  static const String aiDetectorAnimation =
      '${_baseAnimationPath}aiDetector.json';
  static const String translatorAnimation =
      '${_baseAnimationPath}translator.json';
  static const String summarizerAnimation =
      '${_baseAnimationPath}summarizer.json';
  static const String toneEditorAnimation =
      '${_baseAnimationPath}toneEditor.json';
  static const String egmailAnimation = '${_baseAnimationPath}egmail.json';
  static const String jadeAssistantAnimation =
      '${_baseAnimationPath}aiDetector.json'; // Using AI detector for Jade
  static const String jadeAiAnimation = '${_baseAnimationPath}jade_ai.json';
  static const String waveAnimation = '${_baseAnimationPath}wave.json';
    ...
    Widget animationBuilder() {
      ...
      return Lottie.asset(
        ...
        delegates: LottieDelegates(
          values: [
            ValueDelegate.color(const ['**'], value: null)
          ],
        ),
  ...
  static Widget getEgmailAnimation({double? width, double? height}) {
    return getLottieAnimation(
      animationPath: egmailAnimation,
      width: width,
      height: height,
      placeholderIcon: Icons.keyboard,
      placeholderColor: Colors.blue,
  ...
  static Widget getJadeAssistantAnimation({double? width, double? height}) {
    return getLottieAnimation(
      animationPath: jadeAssistantAnimation,
      width: width,
      height: height,
      placeholderIcon: Icons.smart_toy,
      placeholderColor: Colors.deepPurple,
    );
  }

  static Widget getJadeAiAnimation(
      {double? width, double? height, AnimationController? controller}) {
    return getLottieAnimation(
      animationPath: jadeAiAnimation,
      width: width,
      height: height,
      controller: controller,
      placeholderIcon: Icons.psychology_alt,
      placeholderColor: const Color(0xFF00D4AA),
    );
  }

  static Widget getWaveAnimation({double? width, double? height}) {
    return getLottieAnimation(
      animationPath: waveAnimation,
      width: width,
      height: height,
      placeholderIcon: Icons.waves,
      placeholderColor: Colors.blue,
    );
  }
}
