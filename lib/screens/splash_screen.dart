    ...
    try {
      ...
      if (!isFirebaseInitialized) {
        try {
          ...
          _showError('Failed to initialize Firebase. Some features may not work correctly.');
        }
      }
      ...
      if (!isGroqInitialized) {
        try {
          ...
          _showError('Failed to initialize AI services. Some features may be limited.');
        }
      }
      ...
      _showError('An error occurred during initialization. Please restart the app.');
    }
  }
  ...
  void _checkAndNavigate() {
    if (_animationCompleted && (_servicesInitialized || _hasError)) {
      ...
      Timer(const Duration(milliseconds: 500), () {
        if (mounted) {
          // Even if there were errors, we'll still navigate to home
          // but show a snackbar with the error message
          if (_hasError) {
            ...
            AnimatedOpacity(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    _isLoading ? 'Initializing services...' : 'Your AI Writing Assistant',
                    style: TextStyle(
                      fontSize: 16,
