...
class _ProUpgradeScreenState extends State<ProUpgradeScreen> {
  ...
  Widget _buildPlanSelectionScreen(
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: isLoading
            ? Center(child: CircularProgressIndicatorM3E(shape: ProgressM3EShape.wavy, size: CircularProgressM3ESize.m))
  ...
  Widget _buildLoadingPlansCard() {
    return Container(
      ...
      child: Column(
        children: [
          CircularProgressIndicatorM3E(shape: ProgressM3EShape.wavy, size: CircularProgressM3ESize.m),
          const SizedBox(height: 16),
          Text(
