...
class _ParaphraserPageState extends State<ParaphraserPage> {
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Material(
                    ...
                    child: SizedBox(
                      height:
                          screenSize.height * 0.17, // Further reduced height
                      child: TextField(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.symmetric(
                              horizontal: 16,
                              vertical: 4), // Further reduced padding
                          child: CustomButton(
                            text: "Paraphrase",
    ...
    return Column(
      ...
      children: [
        Container(
          height: isSmallScreen
              ? 32.0
              : 36.0, // Use fixed height to prevent overflow
  ...
  Widget _buildPersonaTab(
      Persona persona, bool isSelected, bool isSmallScreen) {
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        Container(
