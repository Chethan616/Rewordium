...
android {
    namespace = "com.chethan616.reboard"
    ...
    defaultConfig {
        applicationId = "com.chethan616.reboard"
        ...
        buildConfigField("String", "FLADDONS_STORE_URL", "\"beta.addons.ReBoard.org\"")
    ...
    bundle {
        language {
            // We disable language split because ReBoard does not use
    ...
    buildTypes {
        named("debug") {
            ...
            resValue("string", "floris_app_name", "ReBoard Debug")
        }
        ...
        create("beta") {
            ...
            resValue("string", "floris_app_name", "ReBoard Beta")
        }
