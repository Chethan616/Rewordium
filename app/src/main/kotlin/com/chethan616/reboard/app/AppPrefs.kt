...
import com.chethan616.reboard.app.settings.theme.ColorPreferenceSerializer
import com.chethan616.reboard.app.settings.theme.DisplayKbdAfterDialogs
import com.chethan616.reboard.app.settings.theme.SnyggLevel
import com.chethan616.reboard.app.setup.NotificationPermissionState
import com.chethan616.reboard.ime.clipboard.CLIPBOARD_HISTORY_NUM_GRID_COLUMNS_AUTO
import com.chethan616.reboard.ime.clipboard.ClipboardSyncBehavior
import com.chethan616.reboard.ime.core.DisplayLanguageNamesIn
import com.chethan616.reboard.ime.core.Subtype
import com.chethan616.reboard.ime.input.CapitalizationBehavior
import com.chethan616.reboard.ime.input.HapticVibrationMode
import com.chethan616.reboard.ime.input.InputFeedbackActivationMode
import com.chethan616.reboard.ime.keyboard.IncognitoMode
import com.chethan616.reboard.ime.keyboard.SpaceBarMode
import com.chethan616.reboard.ime.landscapeinput.LandscapeInputUiMode
import com.chethan616.reboard.ime.media.emoji.EmojiHairStyle
import com.chethan616.reboard.ime.media.emoji.EmojiHistory
import com.chethan616.reboard.ime.media.emoji.EmojiSkinTone
import com.chethan616.reboard.ime.media.emoji.EmojiSuggestionType
import com.chethan616.reboard.ime.nlp.SpellingLanguageMode
import com.chethan616.reboard.ime.onehanded.OneHandedMode
import com.chethan616.reboard.ime.smartbar.CandidatesDisplayMode
import com.chethan616.reboard.ime.smartbar.ExtendedActionsPlacement
import com.chethan616.reboard.ime.smartbar.IncognitoDisplayMode
import com.chethan616.reboard.ime.smartbar.SmartbarLayout
import com.chethan616.reboard.ime.smartbar.quickaction.QuickAction
import com.chethan616.reboard.ime.smartbar.quickaction.QuickActionArrangement
import com.chethan616.reboard.ime.smartbar.quickaction.QuickActionJsonConfig
import com.chethan616.reboard.ime.text.gestures.SwipeAction
import com.chethan616.reboard.ime.text.key.KeyCode
import com.chethan616.reboard.ime.text.key.KeyHintConfiguration
import com.chethan616.reboard.ime.text.key.KeyHintMode
import com.chethan616.reboard.ime.text.key.UtilityKeyAction
import com.chethan616.reboard.ime.text.keyboard.TextKeyData
import com.chethan616.reboard.ime.theme.ThemeMode
import com.chethan616.reboard.ime.theme.extCoreTheme
import com.chethan616.reboard.lib.ext.ExtensionComponentName
import com.chethan616.reboard.lib.observeAsTransformingState
import com.chethan616.reboard.lib.util.VersionName
        ...
        return when (entry.key) {
            ...
            "media__emoji_recently_used" -> {
                ...
                val recent = emojiValues.map {
                    com.chethan616.reboard.ime.media.emoji.Emoji(it, "", emptyList())
                }
