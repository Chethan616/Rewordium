...
interface GlideTypingClassifier {
     ...
     * In Rewordium, we'll use a map of key positions instead of TextKey objects.
     */
    fun setLayout(keyPositions: Map<String, KeyPosition>)
    ...
    /**
     * Simple data class to represent a key's position on the keyboard.
     */
