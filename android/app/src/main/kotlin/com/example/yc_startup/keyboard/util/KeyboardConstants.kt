...
object KeyboardConstants {
    ...
    const val ACTION_SETTINGS_UPDATED = "com.example.yc_startup.SETTINGS_UPDATED"


    // Intent Actions
    const val ACTION_THEME_UPDATED = "com.example.yc_startup.THEME_UPDATED" // Sourced from MainActivity
    const val ACTION_PERSONAS_UPDATED = "com.example.yc_startup.PERSONAS_UPDATED" // Sourced from MainActivity
