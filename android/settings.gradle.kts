...
plugins {
    ...
    id("com.android.library") version "8.7.0" apply false  // For backdrop module
    // START: FlutterFire Configuration
    id("com.google.gms.google-services") version("4.3.15") apply false
    id("com.google.firebase.appdistribution") version "5.0.0" apply false
    // END: FlutterFire Configuration
    id("org.jetbrains.kotlin.android") version "2.1.0" apply false
    id("org.jetbrains.kotlin.jvm") version "2.1.0" apply false  // For pure JVM modules
    id("org.jetbrains.kotlin.plugin.compose") version "2.1.0" apply false  // For Compose in backdrop
    id("org.jetbrains.kotlin.plugin.serialization") version "2.1.0" apply false  // For ReBoard
    id("com.google.devtools.ksp") version "2.1.0-1.0.29" apply false  // For ReBoard Room/KSP
