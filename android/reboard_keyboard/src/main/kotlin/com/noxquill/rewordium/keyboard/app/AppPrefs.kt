...
import com.noxquill.rewordium.keyboard.app.settings.theme.ColorPreferenceSerializer
import com.noxquill.rewordium.keyboard.app.settings.theme.DisplayKbdAfterDialogs
import com.noxquill.rewordium.keyboard.app.settings.theme.SnyggLevel
import com.noxquill.rewordium.keyboard.app.setup.NotificationPermissionState
import com.noxquill.rewordium.keyboard.ime.clipboard.CLIPBOARD_HISTORY_NUM_GRID_COLUMNS_AUTO
import com.noxquill.rewordium.keyboard.ime.clipboard.ClipboardSyncBehavior
import com.noxquill.rewordium.keyboard.ime.core.DisplayLanguageNamesIn
import com.noxquill.rewordium.keyboard.ime.core.Subtype
import com.noxquill.rewordium.keyboard.ime.input.CapitalizationBehavior
...
import com.noxquill.rewordium.keyboard.ime.media.emoji.EmojiHairStyle
import com.noxquill.rewordium.keyboard.ime.media.emoji.EmojiHistory
import com.noxquill.rewordium.keyboard.ime.media.emoji.EmojiSkinTone
import com.noxquill.rewordium.keyboard.ime.media.emoji.EmojiSuggestionType
import com.noxquill.rewordium.keyboard.ime.nlp.SpellingLanguageMode
...
import com.noxquill.rewordium.keyboard.ime.smartbar.ExtendedActionsPlacement
import com.noxquill.rewordium.keyboard.ime.smartbar.IncognitoDisplayMode
...
import com.noxquill.rewordium.keyboard.ime.theme.extCoreTheme
import com.noxquill.rewordium.keyboard.lib.ext.ExtensionComponentName
import com.noxquill.rewordium.keyboard.lib.observeAsTransformingState
import com.noxquill.rewordium.keyboard.lib.util.VersionName
...
abstract class FlorisPreferenceModel : PreferenceModel() {
    ...
    inner class Spelling {
        ...
        val contactsRequestedOnFirstRun = boolean(
            key = "spelling__contacts_requested_on_first_run",
            default = false,
        )
    ...
    inner class Theme {
        ...
        val dayThemeId = custom(
            ...
            default = ExtensionComponentName("com.noxquill.reboardstyle", "reboard_material_light"),
            serializer = ExtensionComponentName.Serializer,
        )
        val nightThemeId = custom(
            key = "theme__night_theme_id",
            default = ExtensionComponentName("com.noxquill.reboardstyle", "reboard_material_dark"),
            serializer = ExtensionComponentName.Serializer,
        )
        val accentColor = custom(
        ...
        return when (entry.key) {
            ...
            "media__emoji_recently_used" -> {
                ...
                val recent = emojiValues.map {
                    com.noxquill.rewordium.keyboard.ime.media.emoji.Emoji(it, "", emptyList())
                }
                val data = EmojiHistory(emptyList(), recent)
                entry.transform(key = "emoji__history_data", rawValue = Json.encodeToString(EmojiHistory.serializer(), data))
            }
            ...
            "smartbar__action_arrangement" -> {
                ...
                val json = QuickActionJsonConfig.encodeToString(QuickActionArrangement.serializer(), newArrangement.distinct())
