...
fun QuickAction.computeDisplayName(evaluator: ComputingEvaluator): String {
    return when (this) {
        is QuickAction.InsertKey -> stringRes(when (data.code) {
            ...
            KeyCode.AI_REWRITE -> R.string.quick_action__ai_rewrite
            KeyCode.AI_PANEL_TOGGLE -> R.string.quick_action__ai_panel
...
fun QuickAction.computeTooltip(evaluator: ComputingEvaluator): String {
    return when (this) {
        is QuickAction.InsertKey -> stringRes(when (data.code) {
            ...
            KeyCode.AI_REWRITE -> R.string.quick_action__ai_rewrite__tooltip
            KeyCode.AI_PANEL_TOGGLE -> R.string.quick_action__ai_panel__tooltip
