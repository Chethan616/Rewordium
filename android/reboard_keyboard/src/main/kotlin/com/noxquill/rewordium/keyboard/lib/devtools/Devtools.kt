...
package com.noxquill.rewordium.keyboard.lib.devtools
...
import com.noxquill.rewordium.keyboard.lib.util.TimeUtils
import com.noxquill.rewordium.keyboard.lib.util.UnitUtils
...
object Devtools {
    ...
    fun generateAppInfoLog(context: Context, withTitle: Boolean = true): String {
        return buildString {
            ...
            append("Package             : ").appendLine(ReboardInfo.APPLICATION_ID)
            append("Name                : ").appendLine(context.resources.getString(R.string.floris_app_name))
            append("Version             : ").appendLine("${ReboardInfo.VERSION_NAME} (${ReboardInfo.VERSION_CODE})")
