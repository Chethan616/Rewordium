...
package com.noxquill.rewordium.keyboard.app.settings.theme
...
import com.noxquill.rewordium.keyboard.app.enumDisplayEntriesOf
...
import com.noxquill.rewordium.keyboard.ime.keyboard.DefaultComputingEvaluator
import com.noxquill.rewordium.keyboard.ime.keyboard.Key
import com.noxquill.rewordium.keyboard.ime.keyboard.KeyData
import com.noxquill.rewordium.keyboard.ime.keyboard.Keyboard
import com.noxquill.rewordium.keyboard.ime.keyboard.KeyboardMode
import com.noxquill.rewordium.keyboard.ime.keyboard.computeImageVector
import com.noxquill.rewordium.keyboard.ime.keyboard.computeLabel
...
import com.noxquill.rewordium.keyboard.lib.NATIVE_NULLPTR
        ...
        object : ComputingEvaluator by DefaultComputingEvaluator {
            override val keyboard = object : Keyboard() {
                ...
                override fun layout(
                    ...
                    extendTouchBoundariesDownwards: Boolean, firstRowHeightFactor: Float,
