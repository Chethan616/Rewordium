...
package com.noxquill.rewordium.keyboard.lib.util
...
private const val IME_SERVICE_CLASS_NAME = "com.noxquill.rewordium.keyboard.FlorisImeService"
    ...
    fun isFlorisboardEnabled(context: Context): Boolean {
        return if (AndroidVersion.ATLEAST_API34_U) {
            context.systemServiceOrNull(InputMethodManager::class)
                ...
                ?.any { it.packageName == ReboardInfo.APPLICATION_ID } ?: false
        } else {
