...
import com.noxquill.rewordium.keyboard.ime.core.SubtypeJsonConfig
import com.noxquill.rewordium.keyboard.ime.core.SubtypeLayoutMap
import com.noxquill.rewordium.keyboard.ime.core.SubtypeNlpProviderMap
import com.noxquill.rewordium.keyboard.ime.core.SubtypePreset
import com.noxquill.rewordium.keyboard.ime.keyboard.LayoutArrangementComponent
import com.noxquill.rewordium.keyboard.ime.keyboard.LayoutType
import com.noxquill.rewordium.keyboard.ime.keyboard.extCorePopupMapping
    ...
    companion object {
        val Saver = Saver<SubtypeEditorState, String>(
            save = { editor ->
                ...
                SubtypeJsonConfig.encodeToString(Subtype.serializer(), subtype)
            },
            restore = { str ->
                val subtype = SubtypeJsonConfig.decodeFromString(Subtype.serializer(), str)
