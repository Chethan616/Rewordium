...
fun AboutScreen() = FlorisScreen {
    ...
    val appVersion = "${ReboardInfo.VERSION_NAME} (${ReboardInfo.VERSION_CODE})"
    ...
    content {
        Column(
            ...
            FlorisCanvasIcon(
                ...
                contentDescription = "ReBoard app icon",
            )
            Text(
        ...
        Preference(
            ...
            onClick = { context.launchUrl(R.string.florisboard__changelog_url, "version" to ReboardInfo.VERSION_NAME) },
        )
        Preference(
