...
import com.noxquill.rewordium.keyboard.ime.keyboard.AbstractKeyData
...
import com.noxquill.rewordium.keyboard.ime.popup.PopupSet
...
import com.noxquill.rewordium.keyboard.lib.Unicode
import com.noxquill.rewordium.keyboard.lib.lowercase
...
data class TextKeyData(
    ...
    companion object {
        ...
        /** Predefined key data for [KeyCode.AI_REWRITE] */
        val AI_REWRITE = TextKeyData(
            type = KeyType.FUNCTION,
            code = KeyCode.AI_REWRITE,
            label = "ai_rewrite",
        )
        /** Predefined key data for [KeyCode.AI_PANEL_TOGGLE] */
        val AI_PANEL_TOGGLE = TextKeyData(
            type = KeyType.SYSTEM_GUI,
            code = KeyCode.AI_PANEL_TOGGLE,
            label = "ai_panel_toggle",
        )
    }
}
