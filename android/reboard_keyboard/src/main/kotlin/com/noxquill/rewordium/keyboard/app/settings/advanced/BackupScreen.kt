...
package com.noxquill.rewordium.keyboard.app.settings.advanced

import com.noxquill.rewordium.keyboard.ReboardInfo
...
object Backup {
    val FILE_PROVIDER_AUTHORITY: String get() = "${ReboardInfo.APPLICATION_ID}.provider.reboard.file"
...
fun BackupScreen() = FlorisScreen {
    ...
    suspend fun prepareBackupWorkspace() {
        ...
        workspace.metadata = Backup.Metadata(
            packageName = ReboardInfo.APPLICATION_ID,
            versionCode = ReboardInfo.VERSION_CODE,
            versionName = ReboardInfo.VERSION_NAME,
