...
import com.noxquill.rewordium.keyboard.lib.io.DefaultJsonConfig
...
data class QuickActionArrangement(
    ...
    object Serializer : PreferenceSerializer<QuickActionArrangement> {
        override fun serialize(value: QuickActionArrangement): String {
            return QuickActionJsonConfig.encodeToString(QuickActionArrangement.serializer(), value)
        }

        override fun deserialize(value: String): QuickActionArrangement {
            return QuickActionJsonConfig.decodeFromString(QuickActionArrangement.serializer(), value)
        }
    }
}
