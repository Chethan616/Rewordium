...
import com.noxquill.rewordium.keyboard.lib.compose.LocalPreviewFieldController
...
import com.noxquill.rewordium.keyboard.lib.util.AppVersionUtils
...
class FlorisAppActivity : ComponentActivity() {
    ...
    private val appContext by lazy { this.appContext().value }
    private val cacheManager by lazy { this.cacheManager().value }
