...
package com.noxquill.rewordium.keyboard.ime.clipboard.provider
...
class ClipboardMediaProvider : ContentProvider() {
    ...
    companion object {
        // Note: Using hardcoded package name since this is used at compile time
        // This should match the host app's applicationId
        const val AUTHORITY_SUFFIX = ".provider.clipboard"
        val AUTHORITY: String get() = ReboardInfo.APPLICATION_ID + AUTHORITY_SUFFIX
        val IMAGE_CLIPS_URI: Uri get() = "content://$AUTHORITY/clips/images".toUri()
        val VIDEO_CLIPS_URI: Uri get() = "content://$AUTHORITY/clips/videos".toUri()
