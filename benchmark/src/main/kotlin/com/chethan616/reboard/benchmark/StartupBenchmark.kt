...
package com.chethan616.reboard.benchmark
...
abstract class AbstractStartupBenchmark(private val startupMode: StartupMode) {
    ...
    private fun startup(compilationMode: CompilationMode) = benchmarkRule.measureRepeated(
        packageName = "com.chethan616.reboard",
        ...
        setupBlock = {
            pressHome()
            device.executeShellCommand("ime enable com.chethan616.reboard/.FlorisImeService")
            device.executeShellCommand("ime set com.chethan616.reboard/.FlorisImeService")
        }
    ) {
